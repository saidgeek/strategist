...
// var Sweepstake = mongoose.model('Sweepstake'),
//     Strategy = mongoose.model('Strategy');

// Strategy.find({ sweepstake: '53af6b3622c482034888b2d7', close: false }, function(err, strategies) {
//   if (!err) {
...
// Sweepstake.findById('53ba980307294dfa285451f2')
...
// Strategy.update({ sweepstake: '53af6b3622c482034888b2d7', close: false }, { close: true }, { multi: true }).exec();

// Sweepstake.findByOneAndUpdate({ _id: '53ba980307294dfa285451f2', is_active: false }, { is_active: true }).exec();