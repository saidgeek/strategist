...
StrategySchema.static('selectStrategyForDraw', function(sweepstake_id, cb) {

  this.find({ sweepstake: sweepstake_id, 'votes.count': { $gt: 0 }, 'moderating': false }, function(err, strategies) {
    if (!err) {
