        ...
        Sweepstake.hasNext(function(err, next_sweepstake) {
          if (!err) {
            ...
            var data = {
              ...
              logo: global.host+'/images/mimejortactica-logo.png',
              title: 'Empiezan los 15 minutos que definen todo, ¡sólo habrá un vencedor!',
              user: {
                name: user.name
              },
              sweepstake: {
              ...
              link: {
                sweepstake: global.host+'/sorteo/'
              }
            };

            Email.build(to, 'Empiezan los 15 minutos que definen todo, ¡sólo habrá un vencedor!', data);
