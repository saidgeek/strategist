...
module.exports = function(app, passport) {
  ...
  // API
  // USERS ==================================/
  app.route('/api/users/contestants/:sweepstake_id')
    .get(middleware.api_auth, users.contestants);
  ...
  app.route('/api/sweepstakes/:id')
    ...
    .put(middleware.api_auth, sweepstake.update)
    .delete(middleware.api_auth, sweepstake.remove)

  app.route('/api/sweepstakes/:id/active')
    .put(middleware.api_auth, sweepstake.is_active);

  app.route('/api/sweepstakes/:id/closed')
    .put(middleware.api_auth, sweepstake.is_closed);
  ...
  // STRATEGY ==================================/
  app.route('/api/strategies/search/:q')
    .get(middleware.api_auth, strategy.search);
  ...
  app.route('/api/win/:user_id/:sweepstake_id')
    .get(middleware.api_auth, win.select);
